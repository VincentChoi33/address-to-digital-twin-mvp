...
6. Run `NVIDIA_API_KEY_FILE=/secure/path/nvidia_api_key npm run nvidia:finish` to deploy/wait, run Content Agents material/physics assignment, rerun SimReady, and rerun acceptance.
