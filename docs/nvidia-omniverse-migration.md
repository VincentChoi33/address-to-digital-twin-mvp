...
4. Replace the browser-side 3D viewport with an Omniverse/ovstream viewer path. NVIDIA viewer guidance explicitly forbids substituting browser-side WebGL as the final USD renderer.
