...
```json
{
  ...
  "checks": [
    ...
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/package.json",
      "status": "passed",
      "evidence": "ovstream_browser_client/package.json size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/package-lock.json",
      "status": "passed",
      "evidence": "ovstream_browser_client/package-lock.json size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/.npmrc",
      "status": "passed",
      "evidence": "ovstream_browser_client/.npmrc size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/index.html",
      "status": "passed",
      "evidence": "ovstream_browser_client/index.html size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/src/main.ts",
      "status": "passed",
      "evidence": "ovstream_browser_client/src/main.ts size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/src/style.css",
      "status": "passed",
      "evidence": "ovstream_browser_client/src/style.css size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/scripts/probe-first-frame.mjs",
      "status": "passed",
      "evidence": "ovstream_browser_client/scripts/probe-first-frame.mjs size and sha256 match."
    },
    {
      "id": "HANDOFF.FILE.ovstream_browser_client/README.md",
      "status": "passed",
      "evidence": "ovstream_browser_client/README.md size and sha256 match."
    },
    {
    ...
    {
      "id": "OVSTREAM.BROWSER_CLIENT_DEP.001",
      "status": "passed",
      "evidence": "browser client depends on NVIDIA @nvidia/ov-web-rtc."
    },
    {
      "id": "OVSTREAM.BROWSER_CLIENT_PROBE_DEP.001",
      "status": "passed",
      "evidence": "browser client includes a Playwright first-frame probe script."
    },
    {
      "id": "OVSTREAM.BROWSER_CLIENT_DIRECT.001",
      "status": "passed",
      "evidence": "browser client uses ov-web-rtc Direct config."
    },
    {
      "id": "OVSTREAM.BROWSER_CLIENT_VIDEO_ONLY.001",
      "status": "passed",
      "evidence": "browser client exposes an HTML video surface and contains no browser-side 3D renderer."
    },
    {
      "id": "OVSTREAM.BROWSER_FIRST_FRAME_PROBE.001",
      "status": "passed",
      "evidence": "browser probe waits for nonzero HTML video dimensions and saves screenshot evidence."
    },
    {
...
## ovstream browser Direct first-frame

```json
{
  "first_frame_report": "docs/evidence/nvidia-train1-ovstream-browser-first-frame-2026-06-12.json",
  "first_frame_screenshot": "docs/evidence/nvidia-train1-ovstream-browser-first-frame-2026-06-12.png",
  "server_report": "docs/evidence/nvidia-train1-ovstream-browser-server-2026-06-12.json",
  ...
  "video": {
    ...
    "readyState": 4,
    "paused": false,
    "metrics": "resize: 1280×720, readyState=4, paused=false",
    "events": "[2026-06-12T12:39:37.752Z] browser.firstVideoFrame {\n  \"videoWidth\": 1280,\n  \"videoHeight\": 720,\n  \"readyState\": 4,\n  \"source\": \"resize\"\n}\n[2026-06-12T12:39:37.738Z] stream {\n  \"action\": \"update\",\n  \"status\": \"success\",\n  \"info\": \"stat-update\",\n  \"data\": {\n    \"stats\": {\n      \"codec\": \"UNKNOWN\",\n      \"fps\": 0,\n      \"rtd\": 0,\n      \"avgDecodeTime\": 0,\n      \"frameLoss\": 0,\n      \"packetLoss\": 0,\n      \"totalBandwidth\": 0,\n      \"currentBitrate\": 0,\n      \"utilizedBandwidth\": 4,\n      \"streamingResolutionHeight\": 0,\n      \"streamingResolutionWidth\": 0\n    }\n  }\n}\n[2026-06-12T12:39:37.262Z] stream {\n  \"action\": \"update\",\n  \"status\": \"success\",\n  \"info\": \"stat-update\",\n  \"data\": {\n    \"stats\": {\n      \"codec\": \"UNKNOWN\",\n      \"fps\": 0,\n      \"rtd\": 0,\n      \"avgDecodeTime\": 0,\n      \"frameLoss\": 0,\n      \"packetLoss\": 0,\n      \"totalBandwidth\": 0,\n      \"currentBitrate\": 0,\n      \"utilizedBandwidth\": 4,\n      \"streamingResolutionHeight\": 0,\n      \"streamingResolutionWidth\": 0\n    }\n  }\n}\n[2026-06-12T12:39:37.236Z] stream {\n  \"action\": \"start\",\n  \"status\": \"success\",\n  \"info\": \"Session started successfully\"\n}\n[2026-06-12T12:39:37.231Z] stream {\n  \"action\": \"update\",\n  \"status\": \"success\",\n  \"info\": \"stat-update\",\n  \"data\": {\n    \"stats\": {\n      \"codec\": \"UNKNOWN\",\n      \"fps\": 0,\n      \"rtd\": 0,\n      \"avgDecodeTime\": 0,\n      \"frameLoss\": 0,\n      \"packetLoss\": 0,\n      \"totalBandwidth\": 0,\n      \"currentBitrate\": 0,\n      \"utilizedBandwidth\": 4,\n      \"streamingResolutionHeight\": 0,\n      \"streamingResolutionWidth\": 0\n    }\n  }\n}\n[2026-06-12T12:39:34.104Z] stream {\n  \"action\": \"start\",\n  \"status\": \"warning\",\n  \"info\": \"2 of 6 connection attempts have failed. Retrying...\"\n}\n[2026-06-12T12:39:31.062Z] stream {\n  \"action\": \"start\",\n  \"status\": \"warning\",\n  \"info\": \"1 of 6 connection attempts have failed. Retrying...\"\n}\n[2026-06-12T12:39:31.018Z] stream {\n  \"action\": \"start\",\n  \"status\": \"inProgress\",\n  \"info\": \"Starting stream.\"\n}\n[2026-06-12T12:39:31.018Z] stream {\n  \"action\": \"start\",\n  \"status\": \"inProgress\",\n  \"info\": \"Starting stream.\"\n}\n"
  },
  "server_status": "passed",
  "server_frames": 76,
  "server_transient_errors": 668,
  "server_first_bgra_frame": {
    "render_var": "LdrColor",
    "source_format": "RGBA8 CUDA",
    "stream_format": "BGRA8 CUDA",
    "shape": [
    ...
    "dtype": "<class 'warp._src.types.uint8'>",
    "step_seconds": 0.981996,
    "copy_rule": "red/blue channels swapped into persistent app-owned warp CUDA buffer"
  }
}
```

![NVIDIA ovstream browser first frame](nvidia-train1-ovstream-browser-first-frame-2026-06-12.png)
